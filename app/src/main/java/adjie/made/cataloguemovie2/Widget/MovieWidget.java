...
public class MovieWidget extends AppWidgetProvider {
    public static final String TOAST_ACTION = "adjie.made.cataloguemovie2.TOAST_ACTION";
    public static final String EXTRA_ITEM = "adjie.made.cataloguemovie2.EXTRA_ITEM";
